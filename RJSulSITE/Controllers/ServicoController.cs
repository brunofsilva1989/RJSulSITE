...
namespace RJSulSITE.Controllers
{
    public class ServicoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ServicoId,NomeServico,Descricao,Preco")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServicoId,NomeServico,Descricao,Preco")] Servico servico)
        {
